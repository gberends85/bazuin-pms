    ...
    <AdminLayout>
      ...
      <div style={{ padding: '24px 28px', maxWidth: 800 }}>
        ...
        <div className="card" style={{ overflow: 'hidden' }}>
          <div style={{ padding: '14px 20px', borderBottom: '0.5px solid rgba(10,34,64,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
          ...
          <div style={{ padding: 20 }}>
            {schedules.length === 0 && (
              <div style={{ textAlign: 'center', color: '#7090b0', padding: '24px 0', fontSize: 13 }}>
                Geen dienstregeling voor deze datum. Klik "Boottijd toevoegen" om tijden in te voeren,<br />
                of het standaard weekschema wordt automatisch gebruikt.
              </div>
            )}
