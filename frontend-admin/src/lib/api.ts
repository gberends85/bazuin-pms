...
export const api = {
  ...
  reservations: {
    ...
    sendLockerEmail: (id: string, variant?: string) => req<any>(`/admin/reservations/${id}/keysafe/send-email`, { method: 'POST', body: JSON.stringify({ variant: variant || 'default' }) }),
  ...
  contractCustomers: {
    ...
    keyDrop: (id: string, d: { licensePlate: string; phone?: string; lockerNumber?: number | null; departureDate?: string; stayId?: number | string | null }) =>
