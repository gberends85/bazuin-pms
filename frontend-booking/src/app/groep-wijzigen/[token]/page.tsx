          ...
          {showCopyLink && (
            <div style={{ paddingTop: 12, borderTop: '1px solid rgba(10,34,64,0.07)' }}>
              <button
                ...
                style={{ fontSize: 12, padding: '6px 12px', borderRadius: 8, border: '1px solid rgba(10,34,64,0.15)', background: linkCopied ? '#e6f7f5' : 'white', color: linkCopied ? '#0a7c6e' : linkLoading ? '#9aafbf' : '#556070', cursor: linkLoading || linkCopied ? 'default' : 'pointer', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 5, transition: 'all 0.15s' }}
              >
    ...
    <div style={{ minHeight: '100vh', background: '#f0f2f5', padding: '20px 16px 48px' }}>
      <div style={{ maxWidth: 520, margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
          ...
          <div>
            <div style={{ fontSize: 16, fontWeight: 800, color: '#0a2240', lineHeight: 1.2 }}>Groepsboeking wijzigen</div>
