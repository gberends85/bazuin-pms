        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)' }}>
          ...
          {cells.map((ds, i) => {
            ...
            const dayBg = (isStart || isEnd) ? '#19499e'
              ...
              : nextNightFull ? `linear-gradient(to right, transparent 30%, ${RED})`
              : prevNightFull ? `linear-gradient(to right, ${RED}, transparent 70%)`
              : 'transparent';
  ...
  return (
    <div style={{ background: 'white', border: '0.5px solid rgba(10,34,64,0.15)', borderRadius: 12, padding: '14px 14px 12px', userSelect: 'none' }}>
      ...
      <div style={{ marginTop: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, fontSize: 11, color: '#7090b0' }}>
        <span style={{ width: 12, height: 12, borderRadius: '50%', background: 'linear-gradient(to right, #f3a9a9, transparent 70%)', border: '1px solid #e3c5c5', display: 'inline-block', flexShrink: 0 }} />
