...
const pool = new Pool({ connectionString: 'postgresql://postgres:BKNq9PBh@localhost:5432/bazuin_pms' });
...
const ALREADY_IMPORTED = new Set([
  21760, 22531, 22558, 22583, 22685, 22955,
  23644, 23654, 23664, 23872, 23962,
  24019, 24023, 24032, 24052, 24098, 24113,
  24120, 24143, 24145, 24147, 24149, 24165,
]);
